          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                ...
                <a href="https://tghclfms.cgg.gov.in/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> </div>
            </header>
            <div className="body">
              <h3> FINANCIAL MANAGEMENT SYSTEM</h3>
              <p> Developed a comprehensive web-based Financial Management System (FMS) incorporating Double 
                  Entry Accounting to facilitate the Accrual Accounting System . </p>
            </div>
            <footer> <ul className="tech-list"> <li>React.js</li> <li>Spring Boot</li> <li>PostgreSQL</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                {/* <a href="https://github.com/CodeVinayak/AI-Chatbot-Assistant" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a> */}
                <a href="https://nzptsfd.telangana.gov.in" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              ...
              <p>
              Designed and implemented the core Java-based backend infrastructure, enhancing website speed and 
              security. 
              </p>
            </div>
            <footer>
